...
class PresentationSource:
    ...
    def as_plan(self, preview_root: Path) -> dict[str, object]:
        ...
        return {
            ...
            "expected_preview_directory": str(
                preview_root / self.experiment_id / safe / SPEC_ID
            ),
...
SOURCES: dict[str, PresentationSource] = {
    "1": PresentationSource(
        ...
        run_tier="full",
        result_schema="exp1_alignment_transfer_v1",
        ...
        required_files=(
            ...
            "metadata/exp1_run_lineage.json",
        ),
        main_figure_id="fig_exp1_alignment_transfer",
    ),
    "2": PresentationSource(
        experiment="Exp2",
        experiment_id="exp2_real_delayed_conversion_logs",
        ...
        run_tier="paper",
        result_schema="exp2_attribution_sensitivity_v2",
    ...
    "3": PresentationSource(
        experiment="Exp3",
        experiment_id="exp3_sequential_recommendation_delayed_feedback",
        ...
        scientific_source_paper_result=True,
        run_tier="full",
        result_schema="exp3_paper_candidate",
        ...
        required_files=(
            ...
            "tables/exp3_ridge_coefficients.csv",
            ...
            "figures/data/exp3_appendix_arrival_carrier_diagnostic_data.csv",
            "figures/data/exp3_appendix_gap_error_distribution_data.csv",
            "figures/data/exp3_appendix_route_selection_concentration_data.csv",
            "manifest.json",
        ),
    ...
    "4": PresentationSource(
        ...
        required_files=(
            ...
            "logs/stages/reporting.json",
            "logs/exp4_stage_config_migration.json",
            "logs/exp4_stage_hash_migration.json",
        ),
...
def get_source(exp: str) -> PresentationSource:
    ...
    if missing:
        raise FileNotFoundError(
            "Missing frozen presentation source files: " + ", ".join(map(str, missing))
        )
    return source
...
def load_run_manifest(source: PresentationSource) -> dict[str, object]:
    candidates = (
        source.source_run / "run_manifest.json",
        source.source_run / "manifest.json",
        source.source_run / "logs" / "run_config.json",
    )
