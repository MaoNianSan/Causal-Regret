...
| 项目 | 结论 |
|---|---|
| 实验版本 | exp4_fast_pipeline_20260622_152145 |
| 当前运行是否可作为论文数值 | 否；fast 仅用于接口、语义与方向检查 |
...
- comparison status: fast_preview_no_formal_inference
- raw arrival–oracle recovery range: [0.0806, 0.5426]
- raw source-labelled-normalized recovery range: [0.1470, 1.0000]
