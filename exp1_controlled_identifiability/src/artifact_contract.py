...
_BASE = (
    ...
    ArtifactSpec(
        "selected_trajectory_points", "processed/selected_trajectory_points.csv"
    ),
    ...
    ArtifactSpec(
        "matched_mean_delay_summary", "summaries/matched_mean_delay_summary.csv"
    ),
...
ARTIFACTS = _BASE + tuple(
    ...
    for artifact in (
        ...
        ArtifactSpec(
            f"{figure_id}_metadata", f"figures/metadata/{figure_id}_metadata.json"
        ),
